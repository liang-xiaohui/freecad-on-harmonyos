...
import __ohos__resourceManager from '@ohos.resourceManager';
import __ohos__settings from '@ohos.settings'
import __ohos__usbManager from '@ohos.usbManager';
import __ohos__usbManager__serial from '@ohos.usbManager.serial';
...
// Keep this export table limited to modules shipped by the API 26 SDK. Qt's
// generic template also lists several optional service kits that FreeCAD does
// not use and that are absent from this SDK distribution.
...
export function getOhosExportModules(): object {
  return {
    ...
    '@ohos.resourceManager': __ohos__resourceManager,
    '@ohos.settings': __ohos__settings,
    '@ohos.usbManager': __ohos__usbManager,
    '@ohos.usbManager.serial': __ohos__usbManager__serial,
