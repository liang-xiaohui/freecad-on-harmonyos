...
echo "  \${DEVECO_SDK_HOME:-.ohos-sdk/26}/toolchains/lib/hap-sign-tool verify-app \\"
...
echo "  还要确认 pack.info 的 releaseType 是 Release（非 Release 会被 AGC 以"
echo "  「使用了 beta 版 API」驳回，换 SDK 见 docs/appgallery-release.md 的 Step 6）。"
echo "  注意 .app 那份 pack.info 是缩进过的 JSON，要容忍冒号两侧的空格："
